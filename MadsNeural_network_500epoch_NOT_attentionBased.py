...
if __name__ == "__main__":
    ...
    dot_img_file = 'C:/Users/madsl/Desktop/model_1.png'
    tf.keras.utils.plot_model(model, to_file=dot_img_file, show_shapes=True,show_layer_activations=True,expand_nested=True)
