...
def load_data(path: str):
    ...
    Parametric_S11 = np.asarray(data_dict['Parametric S1,1'])

    return par_comb, S11_par, Parametric_S11, frequency
...
if __name__ == "__main__":
    ...
    # Load the data
    par_comb, S11_par, parametric, frequency = load_data("data/simple_wire2_final_with_parametric.pkl")

    x = par_comb

    #print(parametric.shape, parametric)

    print(parametric[0])

    y = np.asarray([np.concatenate([x[0], x[1]])for x in parametric])
    print(y.shape, y[0])
