...
# path til cst-filen:
cst_path =  r"C:\Users\madsl\Dropbox\AAU\EIT 7. sem\P7\Python6_stuff\MachineLearning\CST files\Wire_antenna_simple_2.cst"
def represent(para):
...
new_cstfile = r"C:\Users\madsl\Dropbox\AAU\EIT 7. sem\P7\Python6_stuff\MachineLearning\CST files\Wire_antenna_simple_2.cst"
...
for i in range(start, num):
    print(f'Run {i+1}/{num}:')
    toc = time.time()
    s11file =f'C:/Users/madsl/Dropbox/AAU/EIT 7. sem/P7/Python6_stuff/data/wireAntennaSimple2Results/s11/s11_{i}.txt'
...
# "C:\Users\madsl\Dropbox\AAU\EIT 7. sem\P7\Python6_stuff\data\wireAntennaSimple2Results\theta"
    ...
    phi0 = f'data/wireAntennaSimple2Results/theta/phi0_{i}.txt'
    phi45= f'data/wireAntennaSimple2Results/theta/phi45_{i}.txt'
    phi90 = f'data/wireAntennaSimple2Results/theta/phi90_{i}.txt'
    theta0 = f'data/wireAntennaSimple2Results/theta/theta0_{i}.txt'
    theta45 = f'data/wireAntennaSimple2Results/theta/theta45_{i}.txt'
    theta90 = f'data/wireAntennaSimple2Results/theta/theta90_{i}.txt'
