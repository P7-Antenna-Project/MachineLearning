...
sys.path.append('D:\Program files\CST2022\AMD64\python_cst_libraries')
import cst.interface

path = r'F:\Python CST\7_XXX_robustness\Filter\\'

new_cstfile = path+'cst\\filter_data.cst'
